-- Explainable AI Database Schema
-- Run this script in your Supabase SQL Editor

-- Table 1: Literature Evidence (PubMed articles)
...
-- Table 2: Entity Literature Mappings
